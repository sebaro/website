...
/*
	...
	Copyright (C) 2011 - 2021 Sebastian Luncan
	...
	for (var e = elements.length - 1; e >= 0; e--) {
		...
		if (foundSite) {
			...
			if (videoID) {
				...
				if (linkParsers[linkID]['source'].indexOf('vimeo.com') != -1) {
					videoLink += ' | <a href="' + videoURL.replace('vimeo.com', 'player.vimeo.com/video') + '" style="color:#336699;text-decoration:none;">' + videoURL.replace('vimeo.com', 'player.vimeo.com/video') + '</a>';
				}
