...
$q = (isset($query["method"])) ? trim($query["method"]) : "search";
$t = (isset($query["type"])) ? trim($query["type"]) : "food";
$s = (isset($query["string"])) ? trim($query["string"]) : "";
$r = (isset($query["results"])) ? trim($query["results"]) : 500;
